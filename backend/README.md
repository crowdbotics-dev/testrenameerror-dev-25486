...
## Project Structure
    ...
    ├── testrenameerror_dev_25486  # Django project configurations
...
1. Clone this repo and `cd testrenameerror_dev_25486`
...
2. Clone this repo and `cd testrenameerror_dev_25486`
